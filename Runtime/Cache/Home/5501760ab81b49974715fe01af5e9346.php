...
<h4>相册添加</h4>
		<form class="login-form" action="/index.php?s=/Home/album/add.html" method="post">
		          <div class="control-group">
		            <label class="control-label" for="name">相册名</label>
		            <div class="controls">
		              <input type="text" id='name'  name="name"  class="span3" placeholder="请输入相册名（10字以内）"  ajaxurl="/member/checkUserNameUnique.html" errormsg="请填写1-16位用户名" nullmsg="请填写用户名" datatype="*1-16" value="" name="username">
		            </div>
		          </div>
		         <div class="control-group">
		            <label class="control-label" >相册描述</label>
		            <div class="controls">
		            <textarea name='info' class="span3" rows='7'  placeholder="请输入描述(100字以内)"></textarea>
		            </div>
		          </div>
		          <div class="control-group">
