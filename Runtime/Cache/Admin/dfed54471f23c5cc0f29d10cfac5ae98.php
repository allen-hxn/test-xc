...
<body>
	...
	<script type="text/javascript" src="/album/Public/static/uploadify/jquery.uploadify.min.js"></script>
			...
			<form action="<?php echo U();?>" method="post" class="form-horizontal">
				...
				<div id="tab1" class="tab-pane in tab1">
					...
					<div class="controls">
						...
						<?php if(!empty($info['icon'])): ?><div class="upload-pre-item"><img src="/album<?php echo (get_cover($info["icon"],'path')); ?>"/></div><?php endif; ?>
						</div>
					</div>
					...
					$("#upload_picture").uploadify({
				        "height"          : 30,
				        "swf"             : "/album/Public/static/uploadify/uploadify.swf",
